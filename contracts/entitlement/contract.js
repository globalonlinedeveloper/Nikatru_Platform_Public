...
// extensions/.
//
// ⚠️ NOT YET AUTHORITATIVE. services/platform/src/lib/mor/contract.ts still
// declares its own copy of these two sets, and tooling/ci/
// assert-entitlement-contract.mjs still holds that copy — and only that copy —
// equal to the SQL seed rows. Until its limb-4 target list names this file,
// editing here and not there is invisible. See ../README.md, "What is not true
// yet". This header exists so nobody reads the directory's existence as a claim.
// ─────────────────────────────────────────────────────────────────────────────
