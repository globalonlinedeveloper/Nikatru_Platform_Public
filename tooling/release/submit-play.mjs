...
// Private/company/runbooks/store-submission-android.md. Limb (iii) — a submission record
...
if (DRY_RUN) {
  ...
  console.log(`   Console-only steps that must happen first: ${channel.submission?.runbook ?? 'Private/company/runbooks/store-submission-android.md'}`);
