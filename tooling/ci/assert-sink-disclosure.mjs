...
// been fixed at the sink and verified by observation (knowledge/session-notes.md
...
//
// Under this repository's gate-vs-monitor rule (company/PROJECT_STATE.md) that
// makes this file:
