  ...
  if (keys.length === 0) {
    prints.push(
      `INDEXNOW KEY ABSENT (owner-gated, [12]W-3e — proposed OWNER_QUEUE A-11): no key file at ${DEPLOY_ROOT}. ` +
        ...
        'deploy root; nothing here fabricates one. Google ignores IndexNow entirely, so the generated ' +
        'sitemap above is what actually reaches Google and this is the cheap half.',
    );
  }
}
