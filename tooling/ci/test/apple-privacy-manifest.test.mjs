 ...
 * IGNORED (apps/subly/.gitignore:30). It is the right thing for the GUARD to read —
...
const PLUGIN_DEPS_FIXTURE = join(CI_DIR, 'test', 'fixtures', 'subly.flutter-plugins-dependencies.json');
...
test('the committed fixture still matches the real generated file', (t) => {
  ...
  for (const platform of PLATFORMS) {
    ...
    assert.deepEqual(
      names(fixture),
      names(real),
      `the ${platform} plugin set in tooling/ci/test/fixtures/subly.flutter-plugins-dependencies.json ` +
