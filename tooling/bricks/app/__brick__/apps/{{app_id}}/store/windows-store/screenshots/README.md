...
Microsoft requires at least one screenshot per device family the product
claims. No dimension for this channel has been fetched from a primary source,
so `tooling/channel-register.json` declares none and none is enforced —
**UNVERIFIED**, not "anything goes".
