...
> in. So the install is `<repository root>/_playwright/`, which is gitignored. It is not
...
> repository root: `mkdir _playwright && cd _playwright && npm init -y && npm i -D playwright && npx playwright install chromium`.
