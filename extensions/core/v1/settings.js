/* SPDX-License-Identifier: MPL-2.0
   core/v1/settings.js — vendored into a tool as vendor/core/settings.js.

   PROMOTED, NOT WRITTEN. Source: templates/tool/lib/settings.js
   sha256 of that source at promotion: 889185d1ee85b9b0d99fee91fb46ffabd3d65a930c029bc3546a7be2c0321354
   ...
   READ THIS BEFORE VENDORING IT. As promoted, this file is a TEMPLATE: SK_DEFAULTS,
   the two key lists and SK_MIGRATIONS are meant to be filled in per tool, and it
   still carries the skeleton's PLACEHOLDER markers. A vendored core file is
   hash-checked and must NOT be hand-edited in vendor/core/ — those two facts
   contradict each other, and the reconciliation (a schema handed IN by the tool
   instead of declared in the file) is not built. Until it is, treat this as the
   reference copy of a proven implementation, not as a drop-in dependency.
*/
