...
The taxonomy in `Private/company/requirements/analytics-events.md` exists to produce **five numbers**.
...
The wording and the ORDER above mirror `Private/company/requirements/analytics-events.md`
