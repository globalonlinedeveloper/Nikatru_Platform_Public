...
// `catalog/apps.json`. Never hand-edit it; ci.yml runs W-9
// (assert-discovery-surface.mjs) on every pull request and exits 1 when the
// committed bytes differ from the generator's, so a hand edit cannot merge.
